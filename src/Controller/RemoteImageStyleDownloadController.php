 ...
 */
class RemoteImageStyleDownloadController extends FileDownloadController {
  ...
  public function deliver(Request $request, $scheme, ImageStyleInterface $image_style) {
    ...
    // To use this delivery controller, the scheme must be remote.
    $valid &= file_is_scheme_remote($scheme);
    ...
    if ($valid) {
      $valid &= (bool) $this->fileStorage->loadByProperties(['uri' => $image_uri]);
    }
    ...
    if (file_is_scheme_remote($scheme)) {
